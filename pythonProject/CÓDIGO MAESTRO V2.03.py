...
# ==========================================================
# 🚀 ORQUESTADOR V2.04 - CEREBRO CON TIEMPOS DE HOSTINGER
# ==========================================================

def bucle_operativo():
    print(f"💎 MOTOR MAESTRO V2.04 - ONLINE (Memoria + Sync Hostinger)")
    ...
    while True:
        try:
            ...
            if tarea:
                ...
                # Marcamos como 'procesando' de inmediato para bloquear
                ...
                if existentes:
                    print(f"🧠 MEMORIA: {tk_busqueda} encontrada. Sincronizando...")
                ...
                # --- TU LÓGICA DE TIEMPO (10 SEGUNDOS SI HUBO ACCIÓN) ---
                print(f"⏳ Tarea finalizada. Pausa de 10s por si hay otra solicitud...")
                time.sleep(10)

            else:
                # --- MODO REPOSO (1 MINUTO PARA NO SATURAR HOSTINGER) ---
            ...
            if err.errno == 1226:
                print("\n⚠️ Límite Hostinger superado. Pausa de seguridad 5 min...")
                time.sleep(300)
            else:
                print(f"\n❌ Error DB: {err}")
                conn = None
