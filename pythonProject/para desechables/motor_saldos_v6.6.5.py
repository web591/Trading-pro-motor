...
def procesar_bingx(db, uid, ak, as_):
    ...
    try:
        ...
        # BingX Perpetual suele devolver una lista de balances por asset (USDT, BTC, etc)
        ...
        for item in balances:
            ...
            # Usamos los nombres de campos exactos de la v5.5.6
            total = float(item.get("balance", 0))
            locked = float(item.get("freezedMargin", 0)) # Campo clave para futuros
...
# ==========================================================
def run():
    print(f"💎 MOTOR v6.6.5 - SALDOS + TRADES BINANCE-BINGX")
    while True:
