...
def registrar_trade(cursor, uid, t_data, info_traductor, broker_nombre):
    try:
        ...
        # Definimos 'lado' para evitar error de variable no definida
...
def procesar_bingx(db, uid, ak, as_):
    ...
    try:
        ...
        print(f"    [OK] BingX Perpetual saldo procesado: {s_count_perp} activos.")
    except Exception as e: 
    ...
    for o in orders_s:
        ...
        if info:
            ...
            t_count += 1
    print(f"    [SPOT] BingX Open Orders: {t_count} nuevos procesados.")
...
def procesar_bingx_positions(db, uid, ak, as_):
    ...
    try:
        ...
        for p in posiciones:
            ...
            p_count += 1
        print(f"    [OK] Positions Bingx: {p_count} nuevos procesados.")
    ...
    try:
        ...
        for p in posiciones:
            ...
            if abs(position_amt) > 0:
                ...
                p_count += 1
        print(f"    [UM] Binance Potition Risk Orders: {p_count} nuevos procesados.")
...
# Version 1.2 (FIX CONTADOR POSITIONS)
# ==========================================================
...
# ==========================================================
def run():
    print(f"💎 MOTOR v6.6.6.23 - SALDOS + TRADES + OPEN ORDERS + POSITION BINANCE-BINGX")
    while True:
