...
def generar_tarea_incorporacion(cursor, uid, broker, symbol, contexto):
    # Usando nombres estándar de columnas para la tabla de alertas
    sql = """
        INSERT IGNORE INTO sys_tareas_incorporacion
        (user_id, broker, symbol, motivo)
        VALUES (%s, %s, %s, %s)
    """
...
def ejecutar_ciclo_completo():
    print(f"💎 MOTOR v6.6.6.31 - SALDOS + TRADES + OPEN ORDERS + POSITION BINANCE-BINGX INSERT HOMOGENEOS")
