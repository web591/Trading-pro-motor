...
def procesar_bingx(db, uid, ak, as_):
    ...
    try:
        ...
        print(f"[BINGX] Trades spot insertados: {trades_insertados}")
...
# ==========================================================
def run():
    print(f"💎 MOTOR v6.6.6.20 - SALDOS + TRADES + OPEN ORDERS + POSITION BINANCE-BINGX")
    while True:
