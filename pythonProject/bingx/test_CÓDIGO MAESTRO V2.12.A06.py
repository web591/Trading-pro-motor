...
# ==========================================================
# MAPEADOR BINGX v3.0 (CRYPTO + SYNTH SEPARADOS)
# ==========================================================
...
def mapeo_bingx(busqueda):
    ...
    # ======================================================
    # 1️⃣ CRYPTO (NO TOCAR - YA FUNCIONABA)
    # ======================================================
    try:
        ...
        for i in r.get("data", []):
            ...
            if tk in sym:
                ...
                nombre = sym.replace("-USDT","").replace("USDT","")
    ...
    # ======================================================
    # 2️⃣ SYNTH (FOREX / STOCK / COMMODITY / INDEX)
    # ======================================================
    try:
        ...
        for i in r.get("data", []):
            ...
            if tk in nombre or nombre.startswith(tk):
