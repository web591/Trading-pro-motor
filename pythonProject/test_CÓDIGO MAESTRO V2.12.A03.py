...
def mapeo_bingx(busqueda):
    ...
    try:
        ...
        for i in items:
            ...
            # 🔥 ESTE ERA EL BUG
            precio = i.get('price') or i.get('lastPrice')
