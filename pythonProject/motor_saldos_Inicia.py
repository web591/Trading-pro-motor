                ...
                try:
                    ...
                    for b in client.get_account()['balances']:
                        ...
                        if total > 0.0001:
                            ...
                            tipo = 'CASH' if b['asset'] in ['USDT', 'USDC'] else 'EARN'
                    ...
                    try:
                        for f in client.futures_account()['assets']:
                            ...
                            if wb > 0.01:
                                ...
                                cursor.execute("INSERT INTO sys_saldos_usuarios (user_id, broker_name, tipo_cuenta, asset, cantidad_total, pnl_no_realizado, precio_referencia, valor_usd) VALUES (6, 'binance', 'PERPETUAL', %s, %s, %s, %s, %s) ON DUPLICATE KEY UPDATE cantidad_total=%s, pnl_no_realizado=%s, precio_referencia=%s, valor_usd=%s", (f['asset'], wb, pnl, p, (wb+pnl)*p, wb, pnl, p, (wb+pnl)*p))
                    except: pass
